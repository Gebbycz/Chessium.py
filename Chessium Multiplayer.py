...
def main():
    ...
    while True:
        ...
        if not game.game_active or board.is_game_over():
            ...
            elif not game.game_active and not board.is_game_over():
                if game.mode == "p2p":
                    res_str = "Opponent Won (Resignation)" if game.my_turn else "You Won (Resignation)"
                else:
                    res_str = "Game Over via Resignation"
