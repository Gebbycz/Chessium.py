...
def draw_controls(game_instance):
    ...
    elo_val = read_elo()
    elo_surf = small_menu_font.render(f"YOUR ELO: {elo_val}", True, (255, 215, 0))
    screen.blit(elo_surf, (20, BOARD_SIZE + 20))
    
    resign_btn = pygame.Rect(250, BOARD_SIZE + 10, 160, 40)
    pygame.draw.rect(screen, (150, 50, 50), resign_btn, border_radius=5)
    pygame.draw.rect(screen, (220, 100, 100), resign_btn, 2, border_radius=5)
    ...
    draw_btn = pygame.Rect(430, BOARD_SIZE + 10, 160, 40)
    ...
    pygame.draw.rect(screen, draw_color, draw_btn, border_radius=5)
    pygame.draw.rect(screen, draw_border, draw_btn, 2, border_radius=5)
